      ...
      function fetchRemotePackage(packageName, packageSize, callback, errback) {
        ...
        xhr.onprogress = function(event) {
          ...
          if (event.loaded) {
            ...
            total = Math.ceil(total * (Module.expectedDataFileDownloads || 1) / (num || 1));
...
Module['FS_createPath']("/third_party/mediapipe/modules", "face_detection", true, true);
          ...
          DataRequest.prototype = {
            ...
            open: function(mode, name) {
              ...
              try { Module['addRunDependency']('fp ' + this.name); } catch(e) {}
            },
            send: function() {},
            onload: function() {
            ...
            finish: function(byteArray) {
              ...
              try {
                Module['FS_createPreloadedFile'](this.name, null, byteArray, true, true, function() {
                  try { Module['removeRunDependency']('fp ' + that.name); } catch(e) {}
                }, function() {
                  if (that.audio) {
                    try { Module['removeRunDependency']('fp ' + that.name); } catch(e) {}
                  } else {
                ...
                console.warn('FS_createPreloadedFile caught:', e);
              }
            }
          };
      ...
      function processPackageData(arrayBuffer) {
        ...
        var curr;
          ...
          DataRequest.prototype.byteArray = byteArray;
            ...
            var files = metadata['files'];
            for (var i = 0; i < files.length; ++i) {
              var req = DataRequest.prototype.requests && DataRequest.prototype.requests[files[i].filename];
              if (req && typeof req.onload === 'function') {
                try {
                  req.onload();
                } catch(e) {
                  console.warn('DataRequest onload caught:', e);
                }
              }
            }
            try {
